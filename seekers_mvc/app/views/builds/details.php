                        ...
                        <div class="col-md-6">
                            <?php if(isset($_SESSION['usuarioLogado'])): ?>
                                ...
                                <?php if($_SESSION['usuarioLogado'] == $build['autor_id']): ?>
                                    <a href="<?= BASE_URL ?>/editar_build?id=<?= $build['id'] ?>" class="btn btn-warning mb-2">
                                        Editar Build
                                    </a><br>
                                <?php endif; ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php foreach($builds_relacionadas as $build_rel): ?>
                        <div class="mb-3">
                            <a href="<?= BASE_URL ?>/build_detalhes?id=<?= $build_rel['id'] ?>" class="text-decoration-none">
